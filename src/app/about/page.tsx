...
import { buildPersonJsonLd, SEO_DESCRIPTION } from "@/lib/seo/seo";
...
export const metadata: Metadata = {
  ...
  openGraph: { url: canonical, description: SEO_DESCRIPTION },
};
    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-8">
        ...
        <section className="mt-16 max-w-[65ch] space-y-6 text-prose leading-relaxed text-foreground/90">
          ...
          <p>
            Describe what you are building, reading, or exploring. This section
            is a calm snapshot for visitors who want context before they dive
            into your essays.
          </p>
          ...
          <p>
            ...
            your writing together. Keep paragraphs short so scanners stay
            engaged.
          </p>
        </section>
      </div>
